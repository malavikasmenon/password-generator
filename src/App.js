        ...
        return ( 
          <div className = "main">
            ...
            <form onSubmit = {this.handleSubmit} method = "post" className = "form">
              <label >
                Character Count <br/>
                <input type = "text" name = "num" value={this.state.num} onChange={this.handleChange} placeholder="Character Code"/> 
              </label>

              <br/>

              <label className = "container">
                <input type = "checkbox" name = "isDigit" checked = {this.state.isDigit} onChange = {this.handleChange} className = "digits-checkbox" />
              ...
              <label className = "container">  
                <input type = "checkbox" name = "isSymbol" checked = {this.state.isSymbol} onChange = {this.handleChange} />
              ...
              <label className = "container">  
                <input type = "checkbox" name = "isCapital" checked = {this.state.isCapital} onChange = {this.handleChange} />
